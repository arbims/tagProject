...
is_readable('autoload.php') && require __DIR__. '/autoload.php';
...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          =>WWW_ROOT . '/elfinder/files/', // path to files (REQUIRED)
			'URL'           => Router::fullBaseUrl('/'). 'elfinder/files', // URL to files (REQUIRED)
